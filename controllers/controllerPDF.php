...
?>
    ...
    <div class="pdf">
        ...
        <div class="pdf__info" style="margin-bottom: 40px">
                <span class="uppcase">Folio: <?=$detalleVenta["folio"]?></span><br>
                <span class="uppcase">Cliente: <?=$detalleVenta["cliente"]?></span><br>
                <span class="uppcase">Fecha: <?=$detalleVenta["momento"]?></span><br>
        </div>
        ...
        <?php foreach ($detalleVP as $key => $value) : $key++; $totalPro+=$value["cantidad"];?>
                <tr>
                    <td class="pdf__content-table-cell pdf-W10"><?=$key?></td>
                    <td class="pdf__content-table-cell pdf-W10"><?=$value["cantidad"]?></td>
                    <td class="pdf__content-table-cell pdf-W30"><?=$value["producto"]?></td>
                    <td class="pdf__content-table-cell pdf-W20 pdf-TA-r">$<?=$value["precioventa"]?>.00</td>
                    <td class="pdf__content-table-cell pdf-W30 pdf-TA-r">$<?=$value["total"]?>.00</td>
                </tr>
        <?php endforeach ?>
            </table>
            ...
            <table class="pdf__content-table">
                ...
                <tr>
                    ...
                    <td class="pdf__content-table-cell pdf-W30"><?=$totalPro?></td>
                    <td class="pdf__content-table-cell pdf-W10"></td>
                    <td class="pdf__content-table-cell pdf-W20"></td>
                    <td class="pdf__content-table-cell pdf-W30 pdf-TA-r">$<?=$detalleVenta["total"]?>.00</td>
                </tr>
            </table>
