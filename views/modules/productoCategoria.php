<?php
    if (isset($_GET["idcategoria"])) {
        ...
        $productoCategoria = MvcController::seleccionarProductoCategoriaController($item, $valor);
    }
?>
    ...
    ?>
        <div class="fichas">
            ...
            <div class="info">
                ...
                <div class="acciones">
                    <a class="editar" title="Editar" href="index.php?action=productoEditar&idproducto=<?=$value["idproducto"]?>"><i class="fas fa-pen"></i></a>
