<?php
    ...
    if (!isset($_GET["into"])) {
        ...
        $ticket = $_GET["into"];
        $venta = MvcController::recuperarVentaController($ticket);
    ...
    <div class="multi-form-edit">
        ...
        <div class="form-group">
            <table class="tableEntradas">
                <tr>
                    <caption class="thCategorias">Salidas</caption>
                </tr>
                <tr class="d-g">
                    <th class="thSub">#</th>
                ...
                if ($salidas != null) {
                    ...
                    >
                        ...
                        <td>
                            ...
                            <form class="formEliminar" method="post" name="eliminarSalida">
                                ...
                                <?php
                                    ...
                                    $quitarSalida -> uQuitarSalidaController($ticket);
                                ?>
                            </form>
                        </td>
                    </tr>
        ...
        <form class="form-group" name="nuevaSalida" method="post">
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input style="display: inline-block; width: 45%" id="cuantity" type="number" name="cuantity" min="1" step="1" required>
            ...
            <div class="input-group">
                <input type="submit" class="submitEditarProducto" id="btnRegistrarSalida" name="btnRegistrarSalida" value="Agregar">
            </div>
            <?php
                $registro = MvcController::uRegistrarSalidaController($ticket);
                if (isset($_GET["not0"])) {
                    if ($_GET["not0"] == "true") {
                        ?>
